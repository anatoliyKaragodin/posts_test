...
Future<void> setupDI() async {
  ...
  getIt.registerSingleton<PostsRDS>(PostsRDSImpl());

  // Регистрация репозиториев
  final postsRDS = getIt.get<PostsRDS>();

  getIt.registerSingleton<PostsRepository>(PostsRepositiryImpl(rds: postsRDS));

  // Регистрация usecases
  final postsRepository = getIt.get<PostsRepository>();

  getIt.registerSingleton<PostsUsecases>(PostsUsecases(repository: postsRepository));
}
